...
public static class Phase1SkillSpec
{
    ...
    public static System.Collections.Generic.Dictionary<string, SkillDefinition> Build()
    {
        SkillDefinition Def(string id, string name, int range, int mana, int windup, string anim,
            SkillTargetSide side, SkillAmmoResetScope scope, int ammo, params EffectBlock[] effects)
        {
            ...
            return new SkillDefinition
            {
                ...
                AmmoResetScope = scope, Ammo = ammo, Effects = arr
            };
        }
        ...
        // ammo(SK-002): 기본기는 Unlimited, 제한 스킬은 Battle scope + 고정 발수(수치표 초안).
        return new System.Collections.Generic.Dictionary<string, SkillDefinition>
        {
            ...
            ["sword_slash"] = Def("sword_slash", "베기", 1, 0, 0, "Attack", SkillTargetSide.Enemy,
                SkillAmmoResetScope.Unlimited, 0, Dmg(10, 20, SkillDamageType.Physical, 95)),
            ["sword_smash"] = Def("sword_smash", "강타", 1, 15, 0, "Attack", SkillTargetSide.Enemy,
                SkillAmmoResetScope.Battle, 2, Dmg(15, 25, SkillDamageType.Physical, 90), new KnockbackBlock { Distance = 1 }, new StunBlock { Turns = 1, Chance = 20 }),
            ["sword_ironbody"] = Def("sword_ironbody", "금강체", 0, 25, 0, "", SkillTargetSide.Self,
                SkillAmmoResetScope.Battle, 1, new SelfBuffBlock { Kind = SelfBuffKind.DamageTaken, DamageMultiplier = 0.5f, Turns = 3 }),
            // 격투
            ["fist_jab"] = Def("fist_jab", "잽", 1, 0, 0, "Attack", SkillTargetSide.Enemy,
                SkillAmmoResetScope.Unlimited, 0, Dmg(10, 16, SkillDamageType.Physical, 100)),
            ["fist_straight"] = Def("fist_straight", "스트레이트", 1, 10, 0, "Attack", SkillTargetSide.Enemy,
                SkillAmmoResetScope.Battle, 3, Dmg(18, 28, SkillDamageType.Physical, 90)),
            ["fist_sonicblow"] = Def("fist_sonicblow", "소닉 블로", 1, 20, 1, "Attack", SkillTargetSide.Enemy,
                SkillAmmoResetScope.Battle, 1, Dmg(30, 45, SkillDamageType.Physical, 85), new StunBlock { Turns = 1, Chance = 35 }),
            // 활
            ["bow_shot"] = Def("bow_shot", "사격", 5, 0, 0, "Attack", SkillTargetSide.Enemy,
                SkillAmmoResetScope.Unlimited, 0, Dmg(10, 18, SkillDamageType.Physical, 90)),
            ["bow_aimedshot"] = Def("bow_aimedshot", "조준 사격", 5, 15, 1, "Attack", SkillTargetSide.Enemy,
                SkillAmmoResetScope.Battle, 2, Dmg(25, 40, SkillDamageType.Physical, 100)),
            ["bow_bindingarrow"] = Def("bow_bindingarrow", "속박 화살", 5, 20, 0, "Attack", SkillTargetSide.Enemy,
                SkillAmmoResetScope.Battle, 2, Dmg(5, 10, SkillDamageType.Physical, 85), new BindBlock { Turns = 3 }),
            // 지팡이
            ["staff_magicbolt"] = Def("staff_magicbolt", "마탄", 3, 5, 0, "", SkillTargetSide.Enemy,
                SkillAmmoResetScope.Unlimited, 0, Dmg(15, 15, SkillDamageType.Magical, 95)),
            ["staff_chainlightning"] = Def("staff_chainlightning", "연쇄 뇌격", 3, 30, 1, "", SkillTargetSide.Enemy,
                SkillAmmoResetScope.Battle, 1, new ChainBlock { ChainCount = 3, Range = 3, MaxDamage = 20 }),
            ["staff_manaabsorb"] = Def("staff_manaabsorb", "마나 흡수", 3, 0, 0, "", SkillTargetSide.Enemy,
                SkillAmmoResetScope.Battle, 2, Dmg(8, 15, SkillDamageType.Magical, 90), new ManaDrainBlock { Amount = 16, RestoreToCaster = true }),
        };
    }
    ...
    public static string Signature(SkillDefinition d)
    {
        ...
        return $"{d.Id}|{d.DisplayName}|R{d.Range}|A{d.ActCost}|W{d.WindupCost}|M{d.ManaCost}"
               ...
               + $"|scope={(int)d.AmmoResetScope}|ammo={d.Ammo}"
               + $"|[{string.Join(";", effs)}]";
    }
}
#endif
