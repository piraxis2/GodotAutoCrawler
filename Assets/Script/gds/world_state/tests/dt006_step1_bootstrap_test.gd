...
# 실행:
#   godot --headless --path <project> res://Assets/Script/gds/world_state/tests/dt006_step1_bootstrap_test.tscn
#
# 검증 범위:
...
const STORE_SCENE := "res://Assets/Script/gds/world_state/world_state_store.tscn"
