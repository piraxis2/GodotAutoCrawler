...
플러그인 설정 파일은 `addons/world_core/dialogtool/plugin.cfg`다.
...
- debug Play 서브프로세스의 DialoguePlayer가 addon 동봉 example schema
  (`addons/world_core/world_state/examples/world_state_schema_example.tres`)로 **preview 전용 `WorldStateStore`**를
...
| 역할 | 경로 |
| --- | --- |
| EditorPlugin 진입점 | `addons/world_core/dialogtool/dialoguetool.gd` |
| Dialogue 메인 화면 | `addons/world_core/dialogtool/dialoguetool_main.tscn` |
| GraphEdit 저장/로드/validation | `addons/world_core/dialogtool/Editor/editor.gd` |
| 노드 Adapter Registry | `addons/world_core/dialogtool/Editor/Adapter/node_type_registry.gd` |
| 그래프 Resource | `addons/world_core/dialogtool/Resource/dialogue_graph_resource.gd` |
| 런타임 Player | `addons/world_core/dialogtool/RunTime/dialogue_player.gd` |
| 전역 Manager | `addons/world_core/dialogtool/RunTime/dialogue_manager.gd` |
| Dialogue UI | `addons/world_core/dialogtool/UI/dialogue_ui.gd` |
| Portrait Adapter | `addons/world_core/dialogtool/Editor/Adapter/portrait_editor_adapter.gd` |
| State Effect Adapter | `addons/world_core/dialogtool/Editor/Adapter/state_effect_editor_adapter.gd` |
| 런타임 회귀 테스트 | `addons/world_core/dialogtool/RunTime/tests/` |
