...
# 실행:
#   godot --headless --path <project> res://addons/world_core/world_state/tests/dt006_step1_bootstrap_test.tscn
#
# 검증 범위:
...
const STORE_SCENE := "res://addons/world_core/world_state/world_state_store.tscn"
