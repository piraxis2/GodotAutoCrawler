...
#   godot --headless --path <project> res://addons/dialogtool/world_state/condition/tests/dt007_spike_resource_roundtrip.tscn
#
...
const CLAUSE_SCRIPT := "res://addons/dialogtool/world_state/condition/condition_clause.gd"
